...
export type GerUsersQueryVariables = Exact<{ [key: string]: never; }>;


export type GerUsersQuery = { __typename?: 'Query', getUsers: Array<{ __typename?: 'User', id: number, fullname: string, email: string, image?: string | null }> };
...
export const GerUsersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GerUsers"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getUsers"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"fullname"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]}}]} as unknown as DocumentNode<GerUsersQuery, GerUsersQueryVariables>;
/** All built-in and custom scalars, mapped to their actual values */
export type Scalars = {
  ID: { input: string; output: string; }
  String: { input: string; output: string; }
...
export const GerUsersDocument = gql`
    query GerUsers {
  getUsers {
    id
    fullname
...
/**
 * __useGerUsersQuery__
 *
 * To run a query within a React component, call `useGerUsersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGerUsersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGerUsersQuery({
 *   variables: {
 *   },
 * });
 */
export function useGerUsersQuery(baseOptions?: Apollo.QueryHookOptions<GerUsersQuery, GerUsersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GerUsersQuery, GerUsersQueryVariables>(GerUsersDocument, options);
      }
export function useGerUsersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GerUsersQuery, GerUsersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GerUsersQuery, GerUsersQueryVariables>(GerUsersDocument, options);
        }
export function useGerUsersSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GerUsersQuery, GerUsersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GerUsersQuery, GerUsersQueryVariables>(GerUsersDocument, options);
        }
export type GerUsersQueryHookResult = ReturnType<typeof useGerUsersQuery>;
export type GerUsersLazyQueryHookResult = ReturnType<typeof useGerUsersLazyQuery>;
export type GerUsersSuspenseQueryHookResult = ReturnType<typeof useGerUsersSuspenseQuery>;
export type GerUsersQueryResult = Apollo.QueryResult<GerUsersQuery, GerUsersQueryVariables>;